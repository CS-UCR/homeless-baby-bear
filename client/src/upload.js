        ...
        <div class='main-container success-bg'>
            <div class='status-container'>
                <div class='status-txt-container'>
                    ...
                    <p class='status-msg'>
                        {props.last} picture{props.last > 1 ? 's' : ''} had
...
class Upload extends Component {
    ...
    async submitone(one) {
        try {
            await axios
                .post(process.env.REACT_APP_API + '/analyze', { files: one })
                .then(response => {})
                .catch(error => {});
        } catch (error) {}
    }
                ...
                {this.state.flag === 0 ? (
                    ...
                    <div>
                        <div className='image-header'>
                            <img
                                id='logo'
                                src='https://secureservercdn.net/45.40.150.81/enl.69a.myftpupload.com/wp-content/uploads/2017/12/A-Million-Thanks.png'
                                alt='A million thanks logo'
                            ></img>
                            <div className='header-txt'>Picture upload</div>
                        </div>
