...
export class topFive extends Component {
    render() {
        ...
        if (!topFive.value && !topFive.mailCount) {
            return <div className='overviewcard'>Loading..</div>;
        }
        return (
            <div className='overviewcard'>
                ...
                <ol>
                    <li>
                        {topFive.value[0]}, {topFive.mailCount[0]}
                    </li>
                    <li>
                        {topFive.value[1]}, {topFive.mailCount[1]}
                    </li>
                    <li>
                        {topFive.value[2]}, {topFive.mailCount[2]}
                    </li>
                    <li>
                        {topFive.value[3]}, {topFive.mailCount[3]}
                    </li>
                    <li>
                        {topFive.value[4]}, {topFive.mailCount[4]}
                    </li>
                </ol>
            </div>
        );
