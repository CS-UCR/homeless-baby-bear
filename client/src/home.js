...
class App extends Component {
    ...
    getDataFromDbDate = (fromDate, toDate, location_type, clearall) => {
        ...
        if (clearall) this.setState({ data: [] });
    ...
    deleteFromDB = (idTodelete, index, picture) => {
        axios
            .delete(process.env.REACT_APP_API + '/deleteData', {
                data: {
                    id: idTodelete,
                    picture: picture,
                },
    ...
    download = () => {
        ...
        axios
            .post(process.env.REACT_APP_API + '/writetocsv', {
    ...
    updateDB = (updateToApply, _id, setLoading) => {
        axios
            .post(process.env.REACT_APP_API + '/updateAddress', {
    ...
    updateName = (name_var, _id, setLoading, setSuccess) => {
        axios
            .post(process.env.REACT_APP_API + '/updateName', {
                id: _id,
            ...
            <div /*style={sectionStyle}*/>
                ...
                <Container>
                    {this.state.start ? (
                        ...
                        <Typography variant='h5' align='center'>
                            Please select the time period and click search
                        </Typography>
                    )}
                </Container>
            </div>
